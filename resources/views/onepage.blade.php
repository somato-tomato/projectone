         ...
         <div class="col-md-8 col-sm-10">
               <div class="center-item text-center video-content">
                  <h2 class="text-capitalize top50 bottom35  whitecolor">
                     <span class="font-xlight block wow fadeIn" data-wow-delay="400ms">Video Background option
                     </span><span class="block fontbold wow fadeIn" data-wow-delay="500ms">  One Page parallax</span>
                  </h2>
      ...
      <div class="row">
         <div class="col-lg-6 nopadding">
            <div class="split-box text-center center-block container-padding equalheight">
               ...
               <a href="#our-team" class="button btnsecondary pagescroll wow fadeInUp" data-wow-delay="500ms">SEO Team</a>
            </div>
            </div>
         </div>
         <div class="col-lg-6 nopadding">
